...
library ExpMath {
    ...
    function powQ96(int256 x, int256 y) internal pure returns (int256) {
        // Using `ln(x)` means `x` must be greater than 0.
        return expQ96((lnQ96(x) * y) / int256(0x1000000000000000000000000));
    }
    ...
    function expQ96(int256 x) internal pure returns (int256 r) {
        unchecked {
            ...
            r = int256((uint256(r) * 302876040128092160772634998386950922113070325392790627576877) >> uint256(195 - k));
        }
    }
    ...
    function lnQ96(int256 x) internal pure returns (int256 r) {
        ...
        assembly {
            ...
            // Add `ln(2) * k * 2**192`.
            // forgefmt: disable-next-item
            p := add(mul(4350955369971217654477563090224794165364344896676135745070, sub(159, r)), p)
