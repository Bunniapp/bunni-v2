...
contract FuzzEntry_Medusa_Test is Test {
    ...
    function test_auto_inverse_cummulative_amount1_greater_than_equal_to_cummulative_amount1_in_carpeted_geometric_1()
        public
    {
    ...
    function test_auto_inverse_cummulative_amount1_greater_than_equal_to_cummulative_amount1_in_carpeted_geometric_7()
        public
    {
        vm.warp(block.timestamp + 471731);
        vm.roll(block.number + 23310);
    ...
    function test_auto_inverse_cummulative_amount0_greater_than_equal_to_cummulative_amount0_in_uniform_distribution_8()
        public
    {
        vm.warp(block.timestamp + 96);
        vm.roll(block.number + 64);
    ...
    function test_auto_inverse_cummulative_amount1_greater_than_equal_to_cummulative_amount1_in_carpeted_geometric_9()
        public
    {
        vm.warp(block.timestamp + 471731);
        vm.roll(block.number + 23310);
    ...
    function test_auto_inverse_cummulative_amount0_greater_than_equal_to_cummulative_amount0_in_uniform_distribution_10(
    ) public {
        vm.warp(block.timestamp + 96);
        vm.roll(block.number + 64);
        vm.prank(0x0000000000000000000000000000000000030000);
    ...
    function test_auto_inverse_cummulative_amount1_greater_than_equal_to_cummulative_amount1_in_carpeted_geometric_12()
        public
    {
        vm.warp(block.timestamp + 471731);
        vm.roll(block.number + 23310);
    ...
    function test_auto_inverse_cummulative_amount0_greater_than_equal_to_cummulative_amount0_in_uniform_distribution_13(
    ) public {
        vm.warp(block.timestamp + 96);
        vm.roll(block.number + 64);
        vm.prank(0x0000000000000000000000000000000000030000);
    ...
    function test_auto_inverse_cummulative_amount0_greater_than_equal_to_cummulative_amount0_in_uniform_distribution_16(
    ) public {
        vm.warp(block.timestamp + 96);
        vm.roll(block.number + 64);
        vm.prank(0x0000000000000000000000000000000000030000);
    ...
    function test_auto_inverse_cummulative_amount1_greater_than_equal_to_cummulative_amount1_in_carpeted_geometric_17()
        public
    {
        vm.warp(block.timestamp + 471731);
        vm.roll(block.number + 23310);
    ...
    function test_auto_inverse_cummulative_amount0_greater_than_equal_to_cummulative_amount0_in_uniform_distribution_19(
    ) public {
        vm.warp(block.timestamp + 96);
        vm.roll(block.number + 64);
        vm.prank(0x0000000000000000000000000000000000030000);
    ...
    function test_auto_inverse_cummulative_amount1_greater_than_equal_to_cummulative_amount1_in_carpeted_geometric_20()
        public
    {
        vm.warp(block.timestamp + 471731);
        vm.roll(block.number + 23310);
    ...
    function test_auto_inverse_cummulative_amount1_greater_than_equal_to_cummulative_amount1_in_carpeted_geometric_23()
        public
    {
        vm.warp(block.timestamp + 471731);
        vm.roll(block.number + 23310);
    ...
    function test_auto_inverse_cummulative_amount1_greater_than_equal_to_cummulative_amount1_in_carpeted_geometric_24()
        public
    {
        vm.warp(block.timestamp + 471731);
        vm.roll(block.number + 23310);
    ...
    function test_auto_inverse_cummulative_amount0_greater_than_equal_to_cummulative_amount0_in_uniform_distribution_25(
    ) public {
        vm.warp(block.timestamp + 96);
        vm.roll(block.number + 64);
        vm.prank(0x0000000000000000000000000000000000030000);
    ...
    function test_auto_inverse_cummulative_amount1_greater_than_equal_to_cummulative_amount1_in_carpeted_geometric_27()
        public
    {
        vm.warp(block.timestamp + 471731);
        vm.roll(block.number + 23310);
